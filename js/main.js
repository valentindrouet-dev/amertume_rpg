...
(function () {
  ...
  function renderForTab(target) {
    ...
    if (target === 'talentadv') safe('talentadv', Classes.renderAdvTalents);
    ...
    if (target === 'versions') safe('versions', Versions.render);
    if (target === 'cartes') safe('cartes', function () { Cartes.render(); });
  }

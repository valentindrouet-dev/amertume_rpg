...
(function (global) {
  ...
  const TALENT_EFFECTS = [
    ...
    // ❤️ SOINS & SURVIE
    { effect: 'soin_fixe', name: 'Premiers Soins', kind: 'action', cat: 'soin', hasVal: true, defaultVal: 3, valLabel: 'PV rendus',
      desc: 'Action : vous récupérez X PV.' },
    { effect: 'soin_endu', name: 'Second Souffle', kind: 'action', cat: 'soin', hasVal: true, defaultVal: 1, valLabel: 'PV bonus',
      desc: 'Action : vous récupérez ENDU + X PV.' },
    { effect: 'soin_des', name: 'Convalescence', kind: 'action', cat: 'soin', hasVal: true, defaultVal: 2, valLabel: 'Dés de soin 🟩',
      desc: 'Action : vous récupérez X dés de soin (🟩).' },
    { effect: 'regeneration', name: 'Régénération', kind: 'passive', cat: 'soin', hasVal: true, defaultVal: 2, valLabel: 'PV / tour',
      desc: 'Vous récupérez X PV au début de chacun de vos tours.' },
    { effect: 'reanimation', name: 'Réanimation', kind: 'reaction', cat: 'soin', hasVal: true, defaultVal: 5, valLabel: 'PV rendus',
